...
const TAB_BAR_ROUTES = new Set(['pages/plan/plan', 'pages/home/home', 'pages/mine/mine'])
...
const PAGE_TITLES = {
  ...
  'pages/email-settings/email-settings': '邮箱提醒设置',
  'pages/permission-apply/permission-apply': '权限申请',
  'pages/member-tasks/index': '学员任务查看',
  'pages/toolbox/toolbox': '工具箱',
  'pages/toolbox/charger-menu/charger-menu': '充电桩蓝牙',
  'pages/toolbox/charger-bluetooth/charger-bluetooth': '蓝牙连接与收发',
  'pages/toolbox/charger-info/charger-info': '充电桩信息',
  'pages/toolbox/charger-params/params': '参数配置',
  'pages/toolbox/charger-firmware/firmware': '固件升级',
  ...
  'pages/report-history/report-history': '学习记录',
  'pages/report/report': '学习记录',
  'pages/memos/memos': '备忘录',
  'pages/memos/memo-edit': '编辑备忘录',
  'pages/plan-add/plan-add': '新增学习任务',
  'pages/vocab/vocab': '英语单词',
  'pages/task-study/task-study': '学习记录',
