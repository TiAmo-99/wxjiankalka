<template>
  ...
  <scroll-view class="page" :style="themeVars" scroll-y>
    ...
    <view class="tip-card">
      <text>连接成功后，设备通过蓝牙推送 SystemInfo 报文，可在「充电桩信息」中查看型号与版本等数据。</text>
    </view>
  </scroll-view>
</template>
...
const menus = [
  {
    ...
    path: '/pages/toolbox/charger-bluetooth/charger-bluetooth',
    ready: true,
    needConnect: false
  },
  {
    ...
    icon: '📋',
    title: '充电桩信息',
    desc: '型号、软硬件版本、枪数、联网状态',
    path: '/pages/toolbox/charger-info/charger-info',
    ready: true,
    needConnect: true
  },
  {
    ...
    title: '充电监控',
    desc: '充电枪实时数据、启停控制',
    path: '/pages/toolbox/charger-monitor/monitor',
    ready: true,
    needConnect: true
  },
  {
    ...
    title: '参数配置',
    desc: '网络、计费、使能等参数读写',
    path: '/pages/toolbox/charger-stub/charger-stub?key=params',
    ready: false,
    needConnect: true
  },
  {
    ...
    title: '历史记录',
    desc: '故障与充电历史查询',
    path: '/pages/toolbox/charger-stub/charger-stub?key=history',
    ready: false,
    needConnect: true
  },
  {
    ...
    title: '固件升级',
    desc: '分片上传固件包',
    path: '/pages/toolbox/charger-stub/charger-stub?key=firmware',
    ready: false,
    needConnect: true
  }
]
